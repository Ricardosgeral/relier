...
*BME280* chip, which is soldered to the customPCB. If possible the *BME280* should be placed with the tiny sensor pointing to the exterior of the AS box (with openings), 
