...
Please note that such devices are much expensive (1500  to 2000 €) than turbine flowmeters. 
The user should choose, in each test, one of these types of flowmeter.

The following table indicates the advantages and drawbacks of each type of flowmeter. 
