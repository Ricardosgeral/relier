...
The following tables shows the details about most of the components used in ***relier*** **AS**, as well as their indicative prices (in January 2019).
...
### 2.1. Installation of the server software
