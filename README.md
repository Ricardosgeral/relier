...
After automatic rebooting, you need to get your *json* file with the Google Signed credentials.
...
You have three main options:
 ...
 3. ***Start***: initiate right away the test -> Redirects to  **Sensors data record** page.
