...
Now you can grab a big cup of tea! After automatic rebooting, you need to get your *json* file with the Google Signed credentials.
...
Note that, by selecting the option <<Hole Erosion Test (HET)>>
