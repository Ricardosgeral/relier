...
For reference, some links and prices of each component are also presented.
...
| 2       | 0.2      | 0.4      |![](Media/images/sensors/xh254.PNG)         |► [XH2.54 4-Pins connectors Male for PCB - Header+Housing+Terminal](https://www.aliexpress.com/item/XH2-54-2P-3P-4P-5P-6P-7P-8P-9P-10P-11P-12P-13P-14P-15P/32793262315.html)                                           | Connection to the custom PCB                                                         |
...
There may exist cheaper alternatives. The prices indicated correspond to the components acquired for this project.
...
This page allows to select between turbine and eletromagnetic flowmeters.
