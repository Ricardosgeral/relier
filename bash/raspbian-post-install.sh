...
# A raspbian post-install script for erosLab (Erosion Laboratory Test Software) server
# Usage: see README.md https://github.com/Ricardosgeral/erosLab/blob/master/README.md
#
...
echo '-------------------------------------------------------------------------'
echo '=> Raspbian post-install script for erosLab... pick a very hot cup of tea'
echo '-------------------------------------------------------------------------'
...
if [ -d "/home/pi/erosLab" ]; then
    sudo rm -R /home/pi/erosLab
fi
git clone https://github.com/Ricardosgeral/erosLab.git /home/pi/erosLab
#these following two lines may be unnecessary
sudo chown -R pi: /home/pi/erosLab
sudo chmod 777 -R erosLab/
...
sudo cp /home/pi/erosLab/bash/usb-mount.sh /usr/local/bin/usb-mount.sh
sudo sed -i 's/\r//' /usr/local/bin/usb-mount.sh

#Call the script by a system unit file
sudo cp /home/pi/erosLab/services/usb-mount@.service /etc/systemd/system/usb-mount@.service
...
sudo cp /home/pi/erosLab/services/rcshut.service /etc/systemd/system/rcshut.service
...
sudo chmod +w /home/pi/erosLab/shutdown.py
...
sudo cp /home/pi/erosLab/services/shutdown_button.service /etc/systemd/system/shutdown_button.service
sudo systemctl daemon-reload
...
sudo chmod +w /home/pi/erosLab/shutdown_button.py
...
sudo cp /home/pi/erosLab/bash/launcher.sh /home/pi/erosLab/launcher.sh
sudo chmod 755 /home/pi/erosLab/launcher.sh  # this file should be placed in /home/pi/erosionLab/
